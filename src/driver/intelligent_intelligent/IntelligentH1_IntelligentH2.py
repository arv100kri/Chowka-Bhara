...
IntelligentAgent1 Vs IntelligentAgent2
I1 = H1
I2 = H2
'''
...
if __name__ == '__main__': 
    f = open("IntelligentH1_IntelligentH2.txt", "w")
    for i in range(0,50):
        ...
        playerB = Player("IntelligentAgent2", pathArrayB, 4, True)
        ...
        while True:
            ...
            pawnChosen = gameBoard.choosePawnIntelligentVsIntelligent(1,2)
