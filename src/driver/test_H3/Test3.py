...
NaiveAgent Vs RandomAgent
Heuristic Used = H3
'''

from core.game.model.Player import Player
from core.game.model.Board6 import Board
from core.game.timing import * 

if __name__ == '__main__': 
    f = open('NaiveVsRandom_H3.txt', 'w')
    for i in range(0,50):
        ...
        playerA = Player("NaiveAgent", pathArrayA, 4, True)
        ...
        while True:
            ...
            pawnChosen = gameBoard.choosePawnNaiveVsRandom()
