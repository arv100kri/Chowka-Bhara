...
IntelligentAgent Vs NaiveAgent
Heuristic Used = H4 for Intelligent Agent
Heuristic Used = H1 for Naive Agent 
'''

from core.game.model.Player import Player
from core.game.model.Board3 import Board
from core.game.timing import * 

if __name__ == '__main__': 
    f = open("Intelligent_H4VsNaive_H1.txt", "w")
    for i in range(0,50):
